...
namespace Orima02
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            Item trapDeflect =
                new TrapDeflect(ItemName.TrapDeflect,
                    "Reverse all damage to the enemy (this item will be active on the enemy turn");
            Item trapUltimate =
                new TrapUltimate(ItemName.TrapUltimate,
                    "Steal enemy's Ultimate (this item will be active on the enemy turn)");
            ...
            {
                fullRegen, doubleDamage, fullMp, stunBomb, poisonBomb, damageBomb, trapDeflect, trapUltimate,
                abilityTheWorld, abilityOra, abilityUseLeg
            });
